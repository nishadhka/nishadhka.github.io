...
pathtoWRF = '/home/swl-sacon-dst/wrf/WRF341/WRFV3CHEM_par/test/em_real/'
# Path to move wrfout* files - end in a slash!
pathtowrfout = '/home/swl-sacon-dst/wrf/WRF341/WRF_CHEM_trails/WRFCHEM_CBE_A1/WRF/'
...
def edit_namelist(old,new,incolumn=0):
...
if WRF:
    ...
    if submit_job:
        ...
        p_real = subprocess.Popen('./real.exe',cwd=pathtoWRF,shell=False,stdout=subprocess.PIPE)
        p_real.wait()
        ...
        p_wrf = subprocess.Popen('./wrf.exe', cwd=pathtoWRF,shell=False,stdout=subprocess.PIPE)
        p_wrf.wait()
