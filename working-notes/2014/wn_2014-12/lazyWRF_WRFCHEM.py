...
pathtoWPS = '/home/swl-sacon-dst/wrf/WRF341/WRF_CHEM_trails/WRFCHEM_CBE_A6/WPS/'
...
pathtowrfout = '/home/swl-sacon-dst/wrf/WRF341/WRF_CHEM_trails/WRFCHEM_CBE_A6/WRF_output/'
...
pathtoinitdata = '/home/swl-sacon-dst/wrf/WRF341/WRF_CHEM_trails/coimbatore_nesting/gfs/'
...
if WRFCHEM:
    ...
    os.system('rm rsl*')
    print 'Now cleaning mpi logfiles for real.exe and editing namelist.input for convert.exe.'
    ...
    print 'editing namelist for final real.exe and wrf.exe for coarsest domain'
    ...
    os.system('rm rsl*')
    print 'finished real.exe now wrf.exe' 
    ...
    if ndown_d2:
        ...
        print 'Now cleaning mpi logfiles of real.exe and editing namelist.input for convert.exe.'
        edit_namelist_input("io_form_auxinput5",'2,')
        edit_namelist_input("io_form_auxinput6",'2,')
        edit_namelist_input("io_form_auxinput7",'2,')
        edit_namelist_input("io_form_auxinput8",'2,')
        ...
        print 'now running real.exe beofre ndown.exe'
        edit_namelist_input("io_form_auxinput5",'2,')
        edit_namelist_input("io_form_auxinput6",'0,')
        edit_namelist_input("io_form_auxinput7",'0,')
        edit_namelist_input("io_form_auxinput8",'0,')
        ...
        print 'now editing namelist for wrf.exe'
        edit_namelist_input("time_step",'60,')
        ...
        print 'editing over, now running wrf'
        intelligent_mpirun('wrf')
